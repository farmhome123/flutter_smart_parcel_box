...
import 'package:smartparcelbox/controllers/controller.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // ),
              // SizedBox(height: size.height * 0.02),
              // Text('namedefault = $_image'),
              // Text(_imageNameModel?.data.message.file != null
              //     ? '${_imageNameModel?.data.message.file}'
              //     : ''),
              // Text(namefile),
              // FlatButton(
              //     onPressed: () {
